...
class BlogNode:
        ...
        if "topic" in state and state["topic"]:
            prompt="""
                   You are an expert blog content writer. Use Markdown formatting. 
                    Generate exactly **one creative and SEO-friendly title** for the topic: "{topic}".
                    Do not provide alternatives, meta description, or keywords — only the title.
                   """
    ...
    def translation(self,state:BlogState):
        ...
        transaltion_content: Blog = self.llm.invoke(translation_prompt)
        return {
            "blog": {
